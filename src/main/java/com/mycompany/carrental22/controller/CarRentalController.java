package com.mycompany.carrental22.controller;

import com.mycompany.carrental22.CarRental;
import com.mycompany.carrental22.CarRentalFacade;
import com.mycompany.carrental22.util.JsfUtil;
import com.mycompany.carrental22.util.PaginationHelper;
...
public class CarRentalController implements Serializable {
    ...
    @EJB
    private com.mycompany.carrental22.CarRentalFacade ejbFacade;
    ...
    private CarRentalFacade getFacade() {
        return ejbFacade;
    }
    ...
    public CarRental getCarRental(java.lang.Integer id) {
    ...
    public static class CarRentalControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getCarRental(getKey(value));
        }
